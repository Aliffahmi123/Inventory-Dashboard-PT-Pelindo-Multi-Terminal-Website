					...
					<div class="row">
						<div class="card mb-3" style="height : 50px; border-radius:30px;">
							...
							<h3 style="font-family: Helvetica; color : #4e4e4e; letter-spacing: 3px;  margin-top: -35px; opacity:50%;"><b>
									<center>TABEL BARANG MASUK</center>
									<div style=" margin-top:-30px;">
									<a href="cetak.php"><button type="button" class="btn btn-secondary" style="float:right;margin-right:20px; border-radius:10px;">Export PDF</button></a>
									</div>								
								</b></h3>
								...
								<table id="example" class="table table-striped hover" align="center" style="margin-top:20px">
									...
									<thead>
										<tr>
											...
											<th>Jumlah</th>
											<th>Satuan</th>
											<th style="width:12%; word-break: break-all;">Keterangan</th>
											<th>Aksi Admin</th>
										</tr>
									</thead>
									<tbody style="word-break: break-all;">
										...
										<?php while ($data = mysqli_fetch_assoc($tampil)) : ?>
											...
											<tr style="word-break: break-all;">
												...
												<td align="center">
													<img src="view.png" style="width:6%;" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?= $data['id']; ?>">
													<!-- Modal -->
													...
													<a href="edit.php?id=<?= $data['id']; ?>"><img src="edit.png" style="width:5%; margin-left:8px;"></a>
													<a href="hapus.php?id=<?= $data['id']; ?>"><img src="delete.png" style="width:4%; margin-left:10px;"></a>
												</td>
											</tr>
											<?php $id++; ?>
										<?php endwhile; ?>
