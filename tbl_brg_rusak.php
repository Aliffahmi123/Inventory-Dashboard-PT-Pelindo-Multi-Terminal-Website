                    ...
                    <div class="row">
                        <div class="card mb-3" style="height : 50px; border-radius:30px;">
                            ...
                            <h3 style="font-family: Helvetica; color : #4e4e4e; letter-spacing: 3px;  margin-top: -35px; opacity:50%;"><b>
                                    <center>TABEL BARANG RUSAK</center>
                                    <div style=" margin-top:-30px;">
									<a href="cetak4.php"><button type="button" class="btn btn-secondary" style="float:right;margin-right:20px; border-radius:10px;">Export PDF</button></a>
									</div>	
                                </b></h3>
                                        ...
                                        <?php while ($data = mysqli_fetch_assoc($tampil)) : ?>
                                            ...
                                            <tr style="word-break: break-all;">
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a href="edit4.php?id=<?= $data['id']; ?>"><img src="edit.png" style="width:13%; margin-left:8px;"></a>
                                                    <a href="hapus4.php?id=<?= $data['id']; ?>"><img src="delete.png" style="width:11%; margin-left:10px;"></a>
                                                </td>
                                            </tr>
                                            <?php $id++; ?>
                                        <?php endwhile; ?>
