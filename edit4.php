...
$id = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM brg_rusak where id='$id'");
...
if (isset($_POST['update'])) {
    ...
    $queryrun = mysqli_query($conn, "UPDATE brg_rusak SET nama_brg = '$nama_brg', tipe_brg = '$tipe_brg', jlh_brg = '$jlh_brg',kualitas_brg = '$kualitas_brg', tgl = '$tgl', serial_num = '$serial_num',  nama_user = '$nama_user', nama_divisi = '$nama_divisi',  nama_branch = '$nama_branch',gbr = '$gbr', ket = '$ket' where id='$id'")
        or die(mysqli_error($conn));
    if ($queryrun) {
        echo '<script>alert("Data Telah di Update"); document.location="tbl_brg_rusak.php"; </script>';
    }
}
?>
        ...
        <div class="main">
            <nav class="navbar navbar-expand navbar-light navbar-bg" style="background-color: #222e3c; border-radius: 30px; width: 95%; margin-top: 20px; margin-left: 45px; height:50px;">
                <span class="card-title align-middle" style="letter-spacing: 0.5em; margin-top: 10px; font-family: poppins; margin-left: 33%;">
                    ...
                    <h2 style="opacity: 40%; color:white;"><b>UPDATE DATA BARANG RUSAK</b></h2>
                    ...
                    <div class="container-fluid p-0">
                        ...
                        <center>
                            ...
                            <div class="mb-10" style="margin-top:30px">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg" style="width:300px; height: 40px; border-radius:10px; margin-top:-140px;" name="update">Update Data Rusak</button>
                            </div>
                        </center>
                </form>
            </main>
