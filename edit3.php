...
$id = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM brg_pinjaman where id='$id'");
...
if (isset($_POST['update'])) {
    ...
    $queryrun = mysqli_query($conn, "UPDATE brg_pinjaman SET nipp = '$nipp' , nama_user = '$nama_user', nama_brg = '$nama_brg', tipe_brg = '$tipe_brg', kualitas_brg = '$kualitas_brg', tgl = '$tgl', serial_num = '$serial_num', jlh_brg = '$jlh_brg',nama_divisi = '$nama_divisi',nama_branch = '$nama_branch', gbr = '$gbr', ket = '$ket' where id='$id'")
        or die(mysqli_error($conn));
    if ($queryrun) {
        echo '<script>alert("Data Telah di Update"); document.location="tbl_brg_pinjaman.php"; </script>';
    }
}
?>
                    ...
                    <div class="container-fluid p-0">
                        <div class="row">
                            <div class="col-12 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="margin-top:-20px">
                                        <input type="text" class="form-control" value="<?php echo $queryupdate['nipp']; ?>" name="nipp">
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header">
                                    ...
                                    <div class="card-body" style="margin-top:-20px">
                                        <input type="text" class="form-control" value="<?php echo $queryupdate['nama_user']; ?>" name="nama_user">
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header">
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Jumlah Barang Pinjaman</h5>
                                    </div>
                                    <div class="card-body" style="margin-top:-20px">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="margin-top:-20px">
                                        <input type="text" class="form-control" value="<?php echo $queryupdate['nama_divisi']; ?>" name="nama_divisi">
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header">
                                    ...
                                    <div class="card-body" style="margin-top:-20px">
                                        <input type="text" class="form-control" value="<?php echo $queryupdate['nama_branch']; ?>" name="nama_branch">
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="margin-top:-20px">
                                        <textarea class="form-control" rows="1" value="<?php echo $queryupdate['ket']; ?>" name="ket"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <center>
                            ...
                            <div class="mb-10" style="margin-top:30px">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg" style="width:300px; height: 40px; border-radius:10px; margin-top:-140px;" name="update">Update Data Pinjaman</button>
                            </div>
                        </center>
                </form>
            </main>
