...
$query = "SELECT * FROM brg_pinjaman";
                    ...
                    <div class="row">
                        <div class="card mb-3" style="height : 50px; border-radius:30px;">
                            ...
                            <h3 style="font-family: Helvetica; color : #4e4e4e; letter-spacing: 3px;  margin-top: -35px; opacity:50%;"><b>
                                    <center>TABEL BARANG PINJAMAN</center>
                                    <div style=" margin-top:-30px;">
                                        <a href="cetak3.php"><button type="button" class="btn btn-secondary" style="float:right;margin-right:20px; border-radius:10px;">Export PDF</button></a>
                                    </div>
                                </b></h3>
                                ...
                                <table id="example" class="table table-striped hover" align="center" style="margin-top:20px">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Divisi</th>
                                            <th>Branch</th>
                                            <th style="width:13%; word-break: break-all;">Ket</th>
                                    ...
                                    <tbody style="word-break: break-all;">
                                        ...
                                        <?php while ($data = mysqli_fetch_assoc($tampil)) : ?>
                                            ...
                                            <tr style="word-break: break-all;">
                                                ...
                                                <td align="center">
                                                    <img src="view.png" style="width:14%;" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?= $data['id']; ?>">
                                                    <!-- Modal -->
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class=" row">
                                                                        ...
                                                                        <div class="col-sm-8" style="font-size: 15px;">
                                                                            <p align="left">
                                                                                : <?php echo $data['nipp']; ?></br>
                                                                                : <?php echo $data['nama_user']; ?></br>
                                                                                : <?php echo $data['nama_brg']; ?></br>
                                                    ...
                                                    <a href="edit3.php?id=<?= $data['id']; ?>"><img src="edit.png" style="width:12%; margin-left:8px;"></a>
                                                    <a href="hapus3.php?id=<?= $data['id']; ?>"><img src="delete.png" style="width:10%; margin-left:10px;"></a>
                                                </td>
                                            </tr>
                                            <?php $id++; ?>
                                        <?php endwhile; ?>
