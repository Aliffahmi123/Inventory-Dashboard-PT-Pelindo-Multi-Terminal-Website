...
if (isset($_POST['submit'])) {
	...
	$query = "INSERT INTO brg_pinjaman VALUES ('$nipp','$nama_user','$nama_brg','$tipe_brg','$kualitas_brg','$tgl','$jlh_brg','$serial_num','$nama_user','$nama_divisi','$nama_branch','$gbr','$ket')";
	$queryrun = mysqli_query($conn, $query);

	if ($queryrun) {
		$_SESSION['tambah_data_pinjaman'] = "Data Berhasil Di Tambahkan !!";
		header('location: ui-cards.php');
	} else {
		$_SESSION['tambah_data_pinjaman'] = "Data Gagal Di Tambahkan !!";
		header('location: ui-cards.php');
	}
}
...
<body>
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<span class="card-title align-middle" style="letter-spacing: 0.5em; margin-top: 10px; font-family: Adlinnaka;">
					<h2 style="color: #4e4e4e;"><b>Tambah Barang Pinjaman</b></h2>
				</span>
				<!-- <h2 style="font-family: Helvetica; color : lightgray; letter-spacing: 3px;  margin-top: 12px; margin-left: 333px;"><b>BARANG PINJAMAN</b></h2> -->
					...
					<div class="container-fluid p-0">
						<div class="row">
							<div class="col-12 col-lg-4">
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">NIPP</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan NIPP user" name="nipp" required>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
									...
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Nama User" name="nama_user" required>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
								...
								<div class="card">
									...
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Tipe Barang" name="tipe_brg" required>
									</div>
								</div>
							...
							<div class="col-12 col-lg-4">
								<div class="card">
									...
									<div class="card-body" style="margin-top:-20px">
										<select class="form-select" name="kualitas_brg" required>
											<option selected>Masukkan Kondisi</option>
											<option>Baik</option>
								...
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Jumlah Barang di Pinjam</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Jumlah Barang di Pinjam" name="jlh_brg" required>
									</div>
								</div>
							...
							<div class="col-12 col-lg-4">
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Nama Divisi Peminjam</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Nama Divisi Peminjam" name="nama_divisi" required>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Nama Branch Peminjam</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Nama Branch Peminjam" name="nama_branch" required>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
								...
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Keterangan Barang yang di Pinjam</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
										<textarea class="form-control" rows="1" placeholder="Keterangan Barang" name="ket" required></textarea>
									</div>
								</div>
							</div>
						</div>
						<center>
							<div class="mb-10" style="margin-top:30px">
								<button class="btn btn-primary btn-lg" style="width:300px; border-radius:10px;" name="submit">Tambah Data Pinjaman</button>
							</div>
						</center>
				</form>
			</main>
	...
	<?php
	if (isset($_SESSION['tambah_data_pinjaman']) && $_SESSION['tambah_data_pinjaman'] != '') {
	?>
		<script>
			Swal.fire({
				title: "BERHASIL !!",
				text: "Data Barang Pinjaman Berhasil di Simpan",
				icon: "success"
			});
		</script>
	<?php
		// unset($_SESSION['tambah_data_pinjaman']);
	}
	?>
