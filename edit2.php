...
$id = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM brg_keluar where id='$id'");
...
if (isset($_POST['update'])) {
    ...
    $queryrun = mysqli_query($conn, "UPDATE brg_keluar SET nama_brg = '$nama_brg', tipe_brg = '$tipe_brg', kualitas_brg = '$kualitas_brg', tgl = '$tgl',jlh_brg = '$jlh_brg', serial_num = '$serial_num', nama_penginput = '$nama_penginput', nama_divisi = '$nama_divisi',nama_branch = '$nama_branch', gbr = '$gbr', ket = '$ket' where id='$id'")
        or die(mysqli_error($conn));
    if ($queryrun) {
        echo '<script>alert("Data Telah di Update"); document.location="tbl_brg_keluar.php"; </script>';
    }
}
?>
                    ...
                    <div class="container-fluid p-0">
                        <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="margin-top:-20px">
                                        <input type="text" class="form-control" value="<?php echo $queryupdate['nama_penginput']; ?>" name="nama_penginput">
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header">
                            ...
                            <div class="card">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="margin-top:-20px">
                                        <textarea class="form-control" rows="7" value="<?php echo $queryupdate['ket']; ?>" name="ket"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <center>
                            ...
                            <div class="mb-10" style="margin-top:30px">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg" style="width:300px; height: 40px; border-radius:10px; margin-top:-140px;" name="update">Update Data Keluar</button>
                            </div>
                        </center>
                </form>
            </main>
