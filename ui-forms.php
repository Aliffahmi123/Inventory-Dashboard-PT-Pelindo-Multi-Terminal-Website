...
if (isset($_POST['submit'])) {
	...
	$nama_penginput = $_POST['nama_penginput'];
	...
	$query = "INSERT INTO brg_keluar VALUES ('','$nama_brg','$tipe_brg','$kualitas_brg','$tgl','$jlh_brg','$serial_num','$nama_penginput','$nama_divisi','$nama_branch','$gbr','$ket')";
	$queryrun = mysqli_query($conn, $query);

	if ($queryrun) {
		$_SESSION['tambah_data_keluar'] = "Data Berhasil Di Tambahkan !!";
		header('location: ui-forms.php');
	} else {
		$_SESSION['tambah_data_keluar'] = "Data Gagal Di Tambahkan !!";
		header('location: ui-forms.php');
	}
}
...
<body>
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<span class="card-title align-middle" style="letter-spacing: 0.5em; margin-top: 10px; font-family: Adlinnaka;">
					<h2 style="color: #4e4e4e;"><b>Tambah Barang Keluar</b></h2>
				</span>
				<!-- <h2 style="font-family: Helvetica; color : lightgray; letter-spacing: 3px;  margin-top: 12px; margin-left: 365px;"><b>BARANG KELUAR</b></h2> -->
					...
					<div class="container-fluid p-0">
						<div class="row">
							...
							<div class="col-12 col-lg-4">
								...
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Tanggal Keluar</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
							...
							<div class="col-12 col-lg-4">
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Jumlah Barang Keluar</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Jumlah Barang Keluar" name="jlh_brg" required>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
								...
								<div class="card">
									...
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Nama Penginput" name="nama_penginput" required>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Ditujukan ke Divisi</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Tujuan Divisi" name="nama_divisi" required>
									</div>
								</div>
							</div>
							<div class="col-12 col-lg-4">
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Ditujukan ke Branch</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Tujuan Branch" name="nama_branch" required>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
								...
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Keterangan Barang Keluar</h5>
									</div>
									<div class="card-body" style="margin-top:-20px">
						...
						<center>
							<div class="mb-10" style="margin-top:30px">
								<button class="btn btn-primary btn-lg" style="width:300px; border-radius:10px;" name="submit">Tambah Data Keluar</button>
							</div>
						</center>
				</form>
			</main>
	...
	<?php
	if (isset($_SESSION['tambah_data_keluar']) && $_SESSION['tambah_data_keluar'] != '') {
	?>

		<script>
			Swal.fire({
				title: "BERHASIL !!",
				text: "Data Barang Keluar Berhasil di Simpan",
				icon: "success"
			});
		</script>
	<?php
		// unset($_SESSION['tambah_data_keluar']);
	}
	?>
