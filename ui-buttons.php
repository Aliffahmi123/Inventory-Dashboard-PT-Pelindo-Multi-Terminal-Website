...
if (isset($_POST['submit'])) {
	...
	$query = "INSERT INTO brg_masuk VALUES ('','$nama_brg','$tipe_brg','$kualitas_brg','$tgl','$serial_num','$jlh_brg','$satuan','$gbr','$ket')";
	$queryrun = mysqli_query($conn, $query);

	if ($queryrun) {
		$_SESSION['tambah_data'] = "Data Berhasil Di Tambahkan !!";
		header('location: ui-buttons.php');
	} else {
		$_SESSION['tambah_data'] = "Data Gagal Di Tambahkan !!";
...
<body>
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<span class="card-title align-middle" style="letter-spacing: 0.5em; margin-top: 10px; font-family: Adlinnaka;">
					<h2 style="color: #4e4e4e;"><b>Tambah Barang Masuk</b></h2>
				</span>
					...
					<div class="container-fluid p-0">
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body" style="margin-top:-20px">
										<select class="form-select" name="kualitas_brg" required>
											<option selected required>Masukkan Kualitas</option>
											<option>Baik</option>
							...
							<div class="col-12 col-lg-4">
								<div class="card">
									...
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkan Kode SN" name="serial_num" required>
									</div>
								</div>
								<div class="card">
									<div class="card-header">
									...
									<div class="card-body" style="margin-top:-20px">
										<input type="text" class="form-control" placeholder="Masukkaan Jumlah Barang" name="jlh_brg" required>
									</div>
								</div>
							...
							<div class="col-12 col-lg-4">
								<div class="card">
									...
									<div class="card-body" style="margin-top:-20px">
										<textarea class="form-control" rows="19" placeholder="Keterangan Barang" name="ket" required></textarea>
									</div>
								</div>
							</div>
						</div>
						<center>
							<div class="mb-10" style="margin-top:30px">
								<button type="submit" id="simpann" class="btn btn-primary btn-lg" style="width:300px; border-radius:10px;" name="submit">Tambah Data Masuk</button>
							</div>
						</center>
				</form>
			</main>
	...
	<?php
	if (isset($_SESSION['tambah_data']) && $_SESSION['tambah_data'] != '') {
	?>

		<script>
			Swal.fire({
				title: "BERHASIL !!",
				text: "Data Barang Masuk Berhasil di Simpan",
				icon: "success"
			});
		</script>
	<?php
